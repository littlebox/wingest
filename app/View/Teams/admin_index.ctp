<div class="teams index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('captain'); ?></th>
			<th><?php echo $this->Paginator->sort('captain_email'); ?></th>
			<th><?php echo $this->Paginator->sort('tournament_id'); ?></th>
			<th><?php echo $this->Paginator->sort('has_shirts'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($team['Team']['captain']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['captain_email']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['tournament_id']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['has_shirts']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['colores']); ?>&nbsp;</td>
		<td class="actions">
